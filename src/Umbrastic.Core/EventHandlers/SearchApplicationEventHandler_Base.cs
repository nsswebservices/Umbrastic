...
namespace Umbrastic.Core.EventHandlers
{
        ...
        where TSearchSettings : ISearchSettings
    {
        ...
        {
            DashboardHelper.EnsureSection("umbrastic", "Elasticsearch",
                "/App_Plugins/umbrastic/umbrastic.html");
        ...
        private static void InstallServerVars()
        {
            ServerVariablesParser.Parsing += (sender, serverVars) =>
            {
                ...
                umbracoPlugins["umbrastic"] = SearchSettings<TSearchSettings>.Current;
            };
        }
