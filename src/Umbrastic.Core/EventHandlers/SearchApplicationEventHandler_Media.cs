...
namespace Umbrastic.Core.EventHandlers
{
        ...
        where TSearchSettings : ISearchSettings
    {
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual IEnumerable<IMediaIndexService<IMedia>> RegisterMediaIndexingServices()
        {
            return Enumerable.Empty<IMediaIndexService<IMedia>>();
        }
        ...
        protected virtual void IndexMedia(IMediaIndexService<IMedia> indexService, IMedia item, string indexName)
        {
        ...
        /// <param name="item">media item</param>
        /// <param name="indexName">index to add the item to</param>
        protected virtual void RemoveMedia(IMediaIndexService<IMedia> indexService, IMedia item, string indexName)
        {
