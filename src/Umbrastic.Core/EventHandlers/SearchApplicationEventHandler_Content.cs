...
namespace Umbrastic.Core.EventHandlers
{
    ...
    {
        protected virtual IEnumerable<IContentIndexService<IContent>> RegisterContentIndexingServices()
        {
            return Enumerable.Empty<IContentIndexService<IContent>>();
        }
        ...
        protected virtual void IndexContent(IContentIndexService<IContent> indexService, IContent item, string indexName)
        {
        ...
        /// <param name="item">content item</param>
        /// <param name="indexName">index to add the item to</param>
        protected virtual void RemoveContent(IContentIndexService<IContent> indexService, IContent item, string indexName)
        {
        ...
        private void IndexContentCore(IEnumerable<IContent> entities, EventMessages messages)
        {
            ...
            foreach (var item in entities)
            {
                ...
                var indexName = UmbracoSearchFactory.Client.ConnectionSettings.DefaultIndex;
